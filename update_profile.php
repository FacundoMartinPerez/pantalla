...
.update-profile{
 background:url('montaña-nevada.jpg');
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="password" name="update_pass" placeholder="Entre su Antigua Contraseña" class="box">
            <span>Nueva Contraseña :</span>
            <input type="password" name="new_pass" placeholder="Rellene con su Nueva Contraseña" class="box">
